...
/**
 * Class Record representing the bidding record table
 *
 * @param {number} boardNbr  --- Physical number of board
 * @param {number} boardIx   --- Board index (0..), sequential order of play   
 * @param {number} nbrRounds --- Current length of table, nbr of rows
 */
class BiddingRecord {
    constructor(boardNbr, boardIx, nbrRounds) {
        this.boardNbr = boardNbr;
        this.boardIx = boardIx;
        this.nbrRounds = nbrRounds;
    }
    /**
     * @return {number} Board Number
     */
    get boardNbr() {
